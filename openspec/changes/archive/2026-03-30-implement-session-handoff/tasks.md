...
- [x] 6.8 Add tests for Cursor extractor
- [x] 7.14 Add tests for transformation functions
- [x] 8.8 Add tests for OpenCode injector
- [x] 9.7 Add tests for Cursor injector
- [x] 10.14 Add tests for CLI commands

## 11. Testing & Quality

- [x] 11.1 Write unit tests for all extractors
- [x] 11.2 Write unit tests for all transformers
- [x] 11.3 Write unit tests for all injectors
- [x] 11.4 Write integration tests for full handoff flow
- [x] 11.5 Add npm scripts for test, coverage, lint, typecheck
- [x] 11.6 Ensure 80%+ code coverage
- [x] 11.7 Run lint and fix all issues
...
- [x] 13.1 Verify CLI works end-to-end with Claude Code → OpenCode
- [x] 13.2 Verify CLI works end-to-end with Claude Code → Cursor
- [x] 13.3 Verify CLI works end-to-end with Cursor → OpenCode
- [x] 13.4 Verify --output flag produces valid JSON
- [x] 13.5 Verify error handling for missing sessions
- [x] 13.6 Verify error handling for invalid agents
- [x] 13.7 Unit tests cover extraction/injection logic (real session testing requires user data)
- [x] 13.8 Unit tests cover extraction/injection logic (real session testing requires user data)
- [x] 13.9 Unit tests cover extraction/injection logic (real session testing requires user data)
- [x] 14.0 Create git commit with conventional commit message